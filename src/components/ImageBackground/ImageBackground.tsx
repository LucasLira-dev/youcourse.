        ...
        <div className="absolute inset-0 z-20 flex flex-col justify-center container mx-auto px-4">
          ...
          <div
            className='flex items-center mt-3'>
                <Link
                href=""
                className="bg-red-500 hover:bg-red-600 text-white font-semibold py-2 px-4 rounded-lg mt-6 transition-colors">
                    Começar Agora
                </Link>
                <Link
                href='/cursos'
                className='bg-slate-800 hover:bg-slate-700 text-white font-semibold py-2 px-4 rounded-lg mt-6 ml-4 transition-colors'>
                    Ver Cursos
                </Link>
            </div>
        </div>
